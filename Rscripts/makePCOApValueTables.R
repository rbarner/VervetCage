...
#Create table of p-values from anova test with the hypothesis that the mean pcoa value of all the cages are the same
...
#Create table of p-values from anova test with the hypothesis that the mean pcoa value of all the animals are the same
...
#Create table of p-values from anova test with the hypothesis that the mean pcoa value from all of the dates are the same
...
#Create table of p-values from a t-test with the hypothesis that the mean pcoa value of the two diets are the same
tTestTableDiet = function(dataFrame, componentPercentage, newfile)
{
	tValList=numeric(0);
	pValList=numeric(0);
	for(i in (dim(sampleData)[2]+2): length(names(dataFrame)))
...
#Create table of p-values from a t-test with the hypothesis that the mean pcoa value of the two age groups are the same
...
tTestTableDiet(pcaPhylum,pcaPhylumPercent,"/Users/rbarner/Dropbox/FodorLab/KylieData/Analysis/FunctionPrediction/vervet/pcas/pcoaPvalues/diet/ttestDietqiime_Phylum.txt");
tTestTableDiet(pcaClass,pcaClassPercent,"/Users/rbarner/Dropbox/FodorLab/KylieData/Analysis/FunctionPrediction/vervet/pcas/pcoaPvalues/diet/ttestDietqiime_Class.txt");
tTestTableDiet(pcaOrder,pcaOrderPercent,"/Users/rbarner/Dropbox/FodorLab/KylieData/Analysis/FunctionPrediction/vervet/pcas/pcoaPvalues/diet/ttestDietqiime_Order.txt");
tTestTableDiet(pcaFamily,pcaFamilyPercent,"/Users/rbarner/Dropbox/FodorLab/KylieData/Analysis/FunctionPrediction/vervet/pcas/pcoaPvalues/diet/ttestDietqiime_Family.txt");
tTestTableDiet(pcaGenus,pcaGenusPercent,"/Users/rbarner/Dropbox/FodorLab/KylieData/Analysis/FunctionPrediction/vervet/pcas/pcoaPvalues/diet/ttestDietqiime_Genus.txt");
